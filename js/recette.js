...
function ListDinner() {
  return {
    ...
    "verrine-carotte": {
      ...
      formula: [
        "Cuire les carottes.",
        "Mixer les carottes avec le bouillon.",
  ...
  return {
    ...
    cookies: {
      ...
      formula: [
        ...
        "Mélanger la farine, la levure et les oeufs.",
        "Ajouter le sucre et la cassonade.",
        "Ajouter le beurre et bien mélanger à la main.",
        "Ajouter les pépites de chocolat.",
        "Cuire 5-7 minutes.",
      ],
    },
    crumble: {
      ...
      formula: [
		...
		"Couper les pommes et les mettre au fond du plat.",
		"Mélanger à la main le beurre, la farine et le sucre.",
		"Saupoudrer la pate sur les pommes.",
        "Cuire 30 minutes.",
      ],
    },
    gateau_pommes: {
